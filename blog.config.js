...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Unity 启动！',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yuka', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Unity 启动！', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Yuka, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'yuka_10@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  PRISM_THEME_PATH:
      'https://npm.elemecdn.com/prism-themes/themes/prism-darcula.css', // 代码样式主题 更多参考 https://github.com/PrismJS/prism-themes
  ...
  WIDGET_PET_LINK:
      ...
      'https://raw.githubusercontent.com/imuncle/live2d/master/model/katou_01/katou_01.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
